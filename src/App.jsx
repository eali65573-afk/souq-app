...
export default function App() {
  ...
  // 2. حالة منتقي العملة الافتراضية للعرض (الكل يعرض بعملته الأصلية أو عملة موحدة)
  ...
  const formatPrice = (price, fromCurrency) => {
    ...
    // التحويل إلى دولار أولاً ثم إلى العملة المستهدفة
  ...
  // معالج إضافة العرض الجديد وحفظه في قاعدة البيانات
  const handleAddProduct = (e) => {
    ...
    setProducts([newProduct, ...products]); // حقن العرض في رأس قاعدة البيانات
  ...
  return (
    <div style={styles.container}>
      ...
      {/* شريط التصنيفات القابل للتمرير الأفقي السلس */}
        ...
        <div style={styles.overlay}>
          <div style={styles.modal}>
            ...
            <form onSubmit={handleAddProduct} style={styles.modalBody}>
              ...
              <button type="submit" style={styles.submitBtn}>🚀 نشر العرض فوراً في السوق</button>
            </form>
          </div>
        </div>
      )}
